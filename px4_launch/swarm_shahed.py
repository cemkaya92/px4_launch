...
instance_ids = [0, 1, 2, 3, 4, 5, 6]  # Instance IDs
autostart_ids = [4101, 4101, 4101, 4101, 4101, 4101, 4101]  # Autostart IDs for different models
gz_models = ['shahed_136', 'shahed_136', 'shahed_136', 'shahed_136', 'shahed_136', 'shahed_136', 'shahed_136']  # GZ models
sim_models = ['shahed_136', 'shahed_136', 'shahed_136', 'shahed_136', 'shahed_136', 'shahed_136', 'shahed_136']  # Simulation models
model_poses = ["-120,0,1,0,0,0", "-130,0,1,0,0,0", "-140,0,1,0,0,0", "-150,0,1,0,0,0", "-160,0,1,0,0,0", "-170,0,1,0,0,0", "-180,0,1,0,0,0"]  # Model poses (x,y,z,r,p,y)
