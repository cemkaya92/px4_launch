...
autostart_id = 10101  # Autostart IDs for different models
gz_model = 'gc35_e4b'  # GZ models
sim_model = 'gc35_e4b'  # Simulation models
model_pose = "0,0,2.5,0,0,0"  # Model poses (x,y,z,r,p,y)
