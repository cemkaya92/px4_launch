...
autostart_ids = [4101, 4101]  # Autostart IDs for different models
gz_models = ['shahed_136', 'shahed_136']  # GZ models
sim_models = ['shahed_136', 'shahed_136']  # Simulation models
model_poses = ["0,1,1,0,0,0", "-10,1,1,0,0,0"]  # Model poses (x,y,z,r,p,y)
