...
instance_ids = [0, 1, 2]  # Instance IDs
autostart_ids = [4103, 4201, 4201]  # Autostart IDs for different models
gz_models = ['f450_mono_cam', 'asl_rover', 'asl_rover']  # GZ models
sim_models = ['f450_mono_cam', 'asl_rover', 'asl_rover']  # Simulation models
model_poses = ["-5,-2,0.15,0,0,1.6581", "-5,0,0.20,0,0,1.6581", "10,0,0.20,0,0,1.6581"]  # Model poses (x,y,z,r,p,y)
