...
autostart_id = 10111  # Autostart IDs for different models
gz_model = 'mooring_platform'  # GZ models
sim_model = 'mooring_platform'  # Simulation models
model_pose = "0,0,0.3,0,0,0"  # Model poses (x,y,z,r,p,y)
