...
autostart_id = 4101  # Autostart IDs for different models
gz_model = 'shahed_136'  # GZ models
sim_model = 'shahed_136'  # Simulation models
model_pose = "0,2,1,0,0,0"  # Model poses (x,y,z,r,p,y)
