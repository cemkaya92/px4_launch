...
autostart_id = 4012  # Autostart IDs for different models
gz_model = 'flying_wing'  # GZ models
sim_model = 'flying_wing'  # Simulation models
model_pose = "0,0,0.12,0,0,0"  # Model poses (x,y,z,r,p,y)
